                ...
                <div class="app-bar-container">
                    ...
                    <div class="user-block shadow-1" data-role="collapse" data-collapsed="true">
                        <div class="bg-darkCyan fg-white p-2 text-center">
                            ...
                            <div><?php echo $this->session->userdata('range_FL').': '.$this->session->userdata('ratingpilot_name').'<br>'.$this->session->userdata('range_CL').': '.$this->session->userdata('ratingatc_name'); ?></div>
                        </div>
