...
<head>
    ...
    <!-- Metro 4 -->
    <link rel="stylesheet" href="<?php echo APPPATH."views/_include/"; ?>vendors/metro4/css/metro-all.min.css">
    <link rel="stylesheet" href="<?php echo APPPATH."views/_include/"; ?>css/index.css">
