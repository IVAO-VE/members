...
<head>
    ...
    <!-- Metro 4 -->
    <link rel="stylesheet" href="<?php echo base_url()."index.php/_include/"; ?>vendors/metro4/css/metro-all.min.css">
    <link rel="stylesheet" href="<?php echo base_url()."index.php/_include/"; ?>css/index.css">
