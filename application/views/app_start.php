...
<head>
    ...
    <!-- Metro 4 -->
    <link rel="stylesheet" href="<?php echo base_url()."app/_include/"; ?>vendors/metro4/css/metro-all.min.css">
    <link rel="stylesheet" href="<?php echo base_url()."app/_include/"; ?>css/index.css">
