...
<div class="fg-dark container-fluid start-screen h-100">
    ...
    <div data-role="panel" data-title-caption="<?php echo $this->lang->line('staff_dpto03_index'); ?>" data-title-icon="<span class='mif-apps'></span>">
        <div class="bg-white h-100">
            ...
            <div id="trivias">
                <div data-role="panel" data-title-caption="Estado de trivia" data-title-icon="<span class='mif-equalizer'>" data-collapsible="true">
                    <div class="gird">
                        <div class="row">
                ...
                <br>
                <div data-role="panel" data-title-caption="Configurar trivias" data-title-icon="<span class='mif-wrench'>" data-collapsed="true" data-collapsible="true">
                    <?php
                    $data = @file_get_contents('https://utilities.ve.ivao.aero/src/trivia.json');
                    $items = json_decode($data);
                    //print_r($items);
