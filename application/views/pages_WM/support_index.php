...
<div class="m-3">
    <div data-role="panel" data-title-caption="<?php echo $this->lang->line('support_title').' ->'.dirname('/'); ?>" data-collapsible="true" data-title-icon="<span class='mif-help'></span>" class="mt-4">
        <div class="row">
